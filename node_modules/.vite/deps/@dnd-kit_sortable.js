...
import { C as getScrollableAncestors, E as useDndContext, O as useDraggable, S as getFirstCollision, i as KeyboardCode, k as useDroppable, m as closestCorners, x as getClientRect } from "./core.esm-BZ9OKkyb.js";
		...
		droppableContainers.getEnabled().forEach((entry) => {
			...
			switch (event.code) {
				...
				case KeyboardCode.Left:
					...
					break;
				case KeyboardCode.Right: if (collisionRect.left < rect.left) filteredContainers.push(entry);
			}
		});
